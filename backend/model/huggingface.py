...
class HuggingFaceInference:
    def __init__(self, api_token: Optional[str] = None, model_name: str = "meta-llama/Llama-2-7b-chat-hf"):
        """Initialize the Hugging Face inference client."""

        self.api_token = api_token or settings.huggingface_api_key
        if not self.api_token:
            raise ValueError("Please provide a Hugging Face API token either directly or via HF_API_TOKEN environment variable")
